...
- [x] **Chat Transcript Storage**:
  ...
  - [x] Save the _User's_ message to DB upon receipt.
  - [x] Save the _AI's_ full response to DB after streaming completes (or incrementally). _Note: Capturing the full stream content for saving might require a custom `doOnNext` or `reduce` in the Flux._
...
- [x] **Frontend Testing Infrastructure**:
  ...
  - [x] Basic IntakeForm tests (3 passing)
